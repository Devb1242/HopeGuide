...
<body class="sub_page">
  ...
  <div class="container mt-4">
          ...
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#infoModal"
                data-product="Financial Assistance">
                Read More
              </button>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <ul>
                <li>Courts can order offenders to pay restitution to victims for monetary losses resulting from bodily
                  or psychological harm or damage to property caused by the crime.</li>
              </ul>
              <!-- Button to trigger modal -->
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#infoModal"
                data-product="Financial Assistance">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                  <span>Victim Services Toronto</span>
                </h2>
              </div>
              <ul>
                <li>Provides crisis intervention, emotional support, and financial assistance for immediate needs such
                  as funeral expenses and counseling.</li>
                <li>Visit Victim Services Toronto at 40 College St, Toronto, ON M5G 2J3 or call (416) 808-7066</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                  <span>Victim Canadian Resource Centre for Victims of Crime</span>
                </h2>
              </div>
              <ul>
                <li>Financial assistance is available to individual Canadians who are victims of specified serious
                  violent crimes.</li>
                <li>Call (613) 233-7614</li>
              </ul>
              <!-- Button to trigger modal -->
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#infoModal"
                data-product="Financial Assistance">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                  <span>Mothers Against Drunk Driving (MADD) Canada</span>
                </h2>
              </div>
              <ul>
                <li>Provides emotional support, advocacy, and financial assistance for victims of impaired driving,
                  including families of homicide victims.</li>
                <li>Visit MADD Canada at 2010 Winston Park Drive, Suite 500, Oakville Ontario L6H 5R7 or call
                  1-800-665-6233</li>
              </ul>
            </div>
          </div>
    ...
    <div class="text-center mt-5">
      <p class="lead">For more information, visit <a href="https://www.ontario.ca/" target="_blank"
          class="btn btn-outline-primary">Ontario.ca</a> or contact local victim support services.</p>
    </div>
  </div>
    ...
    infoModal.addEventListener('show.bs.modal', function (event) {
      ...
      var productDetails = {
        'Financial Assistance': {
          title: "Criminal Injuries Compensation Board (CICB)",
          eligibility: `<ul>
                <li>Injured as a result of a violent crime, or family members of deceased victims.</li>
                <li>Injuries can be physical or psychological.</li>
                <li>Crime must have occurred in Ontario.</li>
       ...
       <li>Contact CICB: 416-326-2900 or 1-800-372-7463, info.cicb@ontario.ca</li>
          ...
          title: "Restitution",
          eligibility: `<ul>
          <li>Courts can order offenders to pay restitution to victims for monetary losses resulting from bodily or psychological harm or damage to property caused by the crime.</li>
               
        </ul>`,
          document: `<ul>
          <li>Contact Court</li>
                <li>Provide Financial Loss Documents</li>
                <li>Case Related Documents</li>
        </ul>`,
          application: `<ol>
       <li>Contact the Court</li>
              <li>Provide Financial Loss Document</li>
              <li>Attend Court Hearings</li>
        </ol>`,
        }, title: "Victim Services Toronto",
        eligibility: `<ul>
          <li>Provides crisis intervention, emotional support, and financial assistance for immediate needs such as funeral expenses and counseling.</li>    
          <li>Visit Victim Services Toronto at 40 College St, Toronto, ON M5G 2J3 or call (416) 808-7066</li>    
        </ul>`,
        title: "Victim Canadian Resource Centre for Victims of Crime",
        eligibility: `<ul>
          <li>Financial assistance is available to individual Canadians who are victims of specified serious violent crimes.</li>    
          <li>Call (613) 233-7614</li>  
        </ul>`,
        title: "Mothers Against Drunk Driving (MADD) Canada",
        eligibility: `<ul>
          <li>Provides emotional support, advocacy, and financial assistance for victims of impaired driving, including families of homicide victims.</li>    
          <li>Visit MADD Canada at 2010 Winston Park Drive, Suite 500, Oakville Ontario L6H 5R7 or call 1-800-665-6233</li>   
        </ul>`,
      };
      ...
      var applicationDetails = {
        ...
        'Financial Assistance': {
          ...
          <ul>
            ...
            <li><strong>Address:</strong> 789 Maple Avenue, Ottawa, ON, K1A 0B1</li>
            <li><strong>Phone Number:</strong> (613) 555-6789</li>
            <li><strong>Email Address:</strong> john.doe@example.com</li>
            <li><strong>Date of Birth:</strong> February 15, 1975</li>
          </ul>
        `,
          victimInfo: `
          <h4>Part 2: Victim Information</h4>
          <ul>
            <li><strong>Relationship to Victim:</strong> Spouse</li>
            <li><strong>Date of Birth:</strong> March 10, 1980</li>
            <li><strong>Date of Death:</strong> January 20, 2025</li>
            <li><strong>Location of Homicide:</strong> 123 Elm Street, Ottawa, ON</li>
          </ul>
        `,
          injuryInfo: `
          <h4>Part 3: Injury Information</h4>
