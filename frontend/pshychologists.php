...
<body class="sub_page">
  ...
  <section class="team_section py-5">
    <div class="container">
        <div class="text-center mb-4">
            <h2>Available <span class="text-primary">Pshychologists</span></h2>
        </div>
        ...
        <div class="row g-4" id="mentorCards">
            ...
            <div class="col-md-4">
                <div class="card mentor-card">
                    <img src="images/team1.jpg" class="card-img-top" alt="Psychologist 1">
                    <div class="card-body">
 ...
 <script>
    ...
    fetch('http://localhost:5430/v1/user/psychologist/getAllPsychologist?page=1&limit=10', {
      headers: {
    ...
    function renderCards(mentores) {
        ...
        card.innerHTML = `
          ...
          <div class="card mentor-card">
                    <img src="images/undraw_profile_2.svg" class="card-img-top" alt="${mentore.fullName}">
                    <div class="card-body">
                        <h5 class="card-title">${mentore.name}</h5>
