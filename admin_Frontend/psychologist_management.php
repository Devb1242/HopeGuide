...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Psychologist Management</h1>
                        <a href="add_new_psychologist.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class=""></i> Add New Psychologist</a>
                    </div>
    ...
    <script>
        ...
        fetch('http://localhost:5430/v1/admin/psychologist/getAllPsychologist?page=1&limit=10', {
            ...
            .then(data => {
                ...
                data.data.result.forEach(lawyer => {
