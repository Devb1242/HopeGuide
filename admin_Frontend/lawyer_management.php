...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_new_lawyer.php"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class=""></i> Add New
                            Lawyer</a>
                    </div>
    ...
    <script>
        ...
        fetch('http://localhost:5430/v1/admin/loyear/getAllLoyear', {
        ...
        <td>${lawyer.name}</td>
        <td>${lawyer.mobile}</td>
        <td>${lawyer.desctiprion}</td>
        <td>${lawyer.address}</td>
        <td>${lawyer.ratings}</td>
