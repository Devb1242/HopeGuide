<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <div class="sidebar-brand-icon">
            <img src="Icons/samantah Johnson - wellness coaching - menthal help-1.png" alt="" style="width: 40px; height: 40px;">
    </div>
        <div class="sidebar-brand-text mx-3">HopeGuide</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="lawyer_management.php"><i class="fas fa-balance-scale"></i><span>Lawyer Management</span></a>
    </li>
    <li class="nav-item">
